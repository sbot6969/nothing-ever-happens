...
- [ ] Add out-of-sample/walk-forward backtests, not only in-sample tuning.
- [ ] Add latency and cost stress grids.
- [ ] Add category/time/liquidity cohort splits.
- [ ] Add confidence intervals / clustered bootstrap style validation.
...
- [ ] Re-run security review after any new live-mode, wallet, or funding code is added.
- [ ] Run secret scan before any live launch.
- [ ] Review wallet/key handling before any live launch.
...
- [ ] Integrate and push the newly created durable-agent definitions/config if we decide to version them outside repo-local docs.
- [ ] Commit/push any new follow-up docs generated by durable research/quant agents.
